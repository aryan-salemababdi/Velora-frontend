...
source ~/.zshrc`}
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li><code>main.go</code> – application entrypoint</li>
        <li><code>app/</code> – default module with service, controller, and DTO</li>
        <li><code>__tests__/</code> – basic tests for service and controller</li>
      </ul>
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li><code>user.service.go</code></li>
        <li><code>user.controller.go</code></li>
        <li><code>user.module.go</code></li>
        <li><code>dto/user.dto.go</code></li>
        <li><code>__tests__/user.*_test.go</code></li>
      </ul>
...
func (s *Service) FindAll() []string {
    return []string{"example"}
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>If <code>velora</code> command is not found → check your <code>$PATH</code>.</li>
        <li>If <code>go install</code> fails → ensure Go version &gt;= 1.21 is installed.</li>
        <li>If modules don’t register → verify you added them in <code>main.go</code>.</li>
      </ul>
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li><code>velora new [name]</code> → creates a new Velora app</li>
        <li><code>velora g module [name]</code> → generates a module scaffold</li>
        <li>Each module includes service, controller, module, DTO, and tests</li>
      </ul>

      <p className="mt-6 text-gray-400">
        Next: learn how to configure{' '}
        <a href="/documentation/middlewares" className="text-[#00ADD8] underline">
          middlewares
        </a>{' '}
        and{' '}
