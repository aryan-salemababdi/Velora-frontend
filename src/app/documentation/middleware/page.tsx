  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300">
        ...
        specific module). Velora uses a centralized <code>middlewareRegistry</code>{' '}
        to manage them.
      </p>
...
func GetMiddleware(name string) (MiddlewareFunc, bool) {
    ...
    return fn, ok
      ...
      <p className="text-gray-300 my-5">
        ...
        application. They are attached using{' '}
...
app.UseGlobalMiddleware("logging", "cors")`}
      ...
      <p className="text-gray-300 my-5">
        ...
        <code>Middlewares() []string</code> method. This returns an array of
        middleware names that are applied only to that module’s routes.
      </p>
...
{`velora.RegisterMiddleware("auth", func(c *fiber.Ctx) error {
    ...
    return c.Next()
      ...
      <p className="text-gray-300 my-5">
        ...
        <code>[]string{"{"}"auth{"}"}</code> in their <code>Middlewares</code>.
      </p>
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>
          Register middlewares globally with{' '}
          <code>RegisterMiddleware</code>.
        </li>
        <li>
          Apply them globally with <code>UseGlobalMiddleware</code>.
        </li>
        <li>
          Each module <strong>must</strong> implement{' '}
      ...
      <p className="mt-6 text-gray-400">
        Next, learn how to{' '}
        <a href="/documentation/configuration" className="text-[#00ADD8] underline">
          configure Velora
        </a>{' '}
