  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300">
        ...
        <strong>Services</strong> contain the business logic of your
        application. They should not depend on HTTP or controllers directly.
        Services are injected into controllers using Velora’s dependency
        injection system powered by <code>dig.Container</code>.
      </p>
...
func (s *Service) FindAll() []string {
    ...
    return nil
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>
          Keep services independent from HTTP (no <code>fiber.Ctx</code> inside
          services).
        </li>
        <li>Write unit tests for services separately.</li>
        <li>
          Use services to implement core domain logic, reusable across
          controllers.
        </li>
      </ul>
    </motion.div>
